...
const Profile = () => {
  return (
    <>
    <Navbar/>
      <div className="min-h-screen dark:bg-gray-700 bg-gray-200 pt-12 mt-20">

        {/* Card start */}
        <div className="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg md:max-w-lg lg:max-w-xl xl:max-w-2xl">
          <div className="border-b px-4 pb-6">
            <div className="text-center my-4">
              <img className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 mx-auto my-4"
                src={Profileimg} alt="Profile Avatar" />
              <div className="py-2">
                <h3 className="font-bold text-2xl text-gray-800 dark:text-white mb-1">Mayur Nishad</h3>
          ...
          <div className="px-4 py-4">
            ...
            <div className="flex flex-wrap justify-center md:justify-start">
              <div className="flex -space-x-2">
                <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10"
                  src="https://randomuser.me/api/portraits/men/32.jpg" alt="User Avatar" />
                <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10"
                  src="https://randomuser.me/api/portraits/women/31.jpg" alt="User Avatar" />
                <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10"
                  src="https://randomuser.me/api/portraits/men/33.jpg" alt="User Avatar" />
                <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10"
                  src="https://randomuser.me/api/portraits/women/32.jpg" alt="User Avatar" />
                <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10"
                  src="https://randomuser.me/api/portraits/men/44.jpg" alt="User Avatar" />
                <img className="border-2 border-white dark:border-gray-800 rounded-full h-10 w-10"
                  src="https://randomuser.me/api/portraits/women/42.jpg" alt="User Avatar" />
                <span
